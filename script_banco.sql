...
INSERT INTO usr_usuario (nome, email, senha)
VALUES ('admin', 'admin@email.com', '$2y$12$.RWfoFef/X0E3ebgeTSW5ObdF2RSqGRxGU73bRBFBKVJboSp4JYJa');
INSERT INTO roles (role_name)
values ('ROLE_ADMIN');
INSERT INTO roles (role_name)
values ('ROLE_COMERCIAL');
INSERT INTO roles (role_name)
values ('ROLE_USUARIO_COMUM');
INSERT INTO usr_has_roles
VALUES (1, 1);